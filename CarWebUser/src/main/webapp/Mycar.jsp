...
<!-- 放置主体页面 -->
<iframe data-frameid="'+id+'" scrolling="auto" frameborder="0" src="http://localhost:8080/Welcome/content.jsp" style="width:100%;height:99%;"></iframe>
<dd><a data-url="content" data-id="11" data-title="用户信息管理" href="#" class="site-demo-active" data-type="tabAdd" href="javascript:;"></a></dd>
<!-- 放置主体页面 -->
