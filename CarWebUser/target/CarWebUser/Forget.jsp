        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <script type="text/html" template>
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="cellphone" id="LAY-user-login-cellphone" lay-verify="phone" placeholder="请输入注册时的邮箱账号" class="layui-input">
                </div>
                <div class="layui-form-item">
                    <div class="layui-row">
                ...
                <div class="layui-form-item">
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs5">
                            <div style="margin-left: 10px;">
                                <button type="button" class="layui-btn layui-btn-primary layui-btn-fluid" id="LAY-user-getsmscode" onclick="VerifiCode()">获取验证码</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="LAY-user-forget-submit" onclick="Forget()">找回密码</button>
                </div>
                {{# } }}
            </script>
...
<script>
    ...
    function VerifiCode() {
        ...
        data={
            "email" :$("#LAY-user-login-cellphone").val()
        }
        if(data.email==null)
        {
            alert("请先输入邮箱");
    ...
    function Forget(){
        data={
            ...
            "vercode":$("#LAY-user-login-smscode").val()
        }
        if(data.password==""||data.email==""||data.vercode==""){
            alert("请输入完整的信息");
        }
        else if(data.vercode!=ccode)
        {
            ...
            window.location.href="http://localhost:8080/Welcome/Forget2.jsp";
        }
    }
