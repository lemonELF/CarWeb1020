...
<form class="layui-form" action="" id="updateForm" style="display:none" lay-filter="update" enctype="multipart/form-data">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div class="layui-input-inline">
            <input type="text" name="CarId" lay-verify="description" autocomplete="off" placeholder="请输入车辆编号" class="layui-input">
            </div>
        </div>
    </div>
...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container" style="margin-top: 4px;margin-left: 4px;">
        ...
        <button class="layui-btn layuiadmin-btn-list" data-type="add" onclick="addonclick()">添加</button>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#test'
            ,url:'http://localhost:8080/Welcome/RepServlet'
            ,method:"get"
            ...
            ,cols: [[
                ...
                ,{field:'recentCareDay', title:'近期保养日期', width:170,edit: 'text',}
                ,{field:'CareTime', title:'保养次数', width:100,edit: 'text',}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('确认要删除吗?', {icon: 3, title:'删除'}, function(index){
                    $.ajax({
                        url:'/Welcome/RepDelServlet?action=removetmp&id='+upid,
                        method:'get',
                        data:data.field,
                        dataType:'JSON',
        ...
        form.on('submit(demoupd)', function(data){
            ...
            $.ajax({
                url:'/Welcome/RepUpdServlet?id='+upid,
                method:'get',
                data:data.field,
                dataType:'JSON',
                success:function(res){
